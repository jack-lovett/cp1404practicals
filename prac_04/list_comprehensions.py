...
long_full_names = [full_name for full_name in full_names if len(full_name) > 11]
last_names = []
for long_full_name in long_full_names:
    last_names.append(long_full_name.split()[-1])
